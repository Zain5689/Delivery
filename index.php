...
<body>
    <h1 align='center' style="margin: 15px; color:#e84118;font-weight: bold;font-family: system-ui">DELIVEE COURIER SERVICE</h1>
    <hr style=" background-color:#333" />

    <P align='center' style="color:#273c75;font-family:font-family: system-ui">The Fastest Courier Service Ever</P>

    <div>
        <h5><a href="admin/adminlogin.php" style="float: right; margin-right:40px; margin-top:0px">Admin Login</a></h5>
    </div>
    <div class="container" style="margin-top: 60px; width:50%;">
        <div class="row">
            <div class="col-md-12">
                <h2 style="color: #273c75;text-align:center;margin:10px;font-weight: bold;">Login</h2>
